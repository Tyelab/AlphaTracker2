    ...
    def __init__(self,img_folder= '../data/coco/images/', annot_file='../data/coco/annot_coco.h5', 
        ...
        with h5py.File(annot_file, 'r') as annot:
            if self.is_train:
                ...
                self.imgname_coco_train = np.load(r'C:\Users\AneeshBal\Desktop\browtf\Weights\PoseEstimator\exp15\train_names.npy')
                ...
                self.imgname_coco_val = np.load(r'C:\Users\AneeshBal\Desktop\browtf\Weights\PoseEstimator\exp15\val_names.npy')
